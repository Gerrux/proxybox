...
Русский, английский и персидский — переключатель в настройках, за кнопкой в
титульной
...
и `PG_LANG=fa`; всё непонятое — английский, пустое — русский.
...
- Персидский перевод не читал носитель языка. Полноту таблиц стерегут тесты, а
  ...
  Отдельно не проверен экран помощи CLI: колонки команд там латиницей, а
  пояснения — персидские, и раскладывает это терминал, а не мы.
