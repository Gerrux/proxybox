...
единственное место, где видно **расхождение намерения и результата**: правило
sing-box по `process_path` сверяет путь побайтово, и промах у него тихий —
приложение уходит напрямую, не переставая считаться защищённым. Выбранное
