...
- Системного меню окна нет: ни по правому клику на титульной полосе, ни по
  Alt+Space. У безрамочного окна полоса лежит в клиентской области, куда
  Windows своё меню не приносит, — нужна своя команда с `TrackPopupMenu`.
