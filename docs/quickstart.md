...
Это про Windows — сегодня это единственная платформа с окном. На Linux служба
и её консоль уже работают, но экрана для них пока нет: путь тот же по сути,
только целиком в терминале — [install.md](install.md) и
