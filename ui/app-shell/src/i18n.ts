...
const RU = {
  ...
  up: "Подключено",
  upHintWhitelist: (n: number) => `Через туннель: ${n} приложений. Остальным доступ в интернет закрыт`,
  upHintAll: "Все приложения используют туннель",
  ...
  scopeWhitelist: "Только выбранные",
