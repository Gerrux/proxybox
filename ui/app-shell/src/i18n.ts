...
const RU = {
  ...
  browserMismatch: (real: string) =>
    `Sec-CH-UA и navigator.platform подменяются вместе со строкой, но шрифты, отрисовка и WebGL остаются от «${real}»: сайт, который сличает их со строкой, увидит расхождение.`,
  browserUa: "user-agent — пусто, значит настоящий",
  browserUaField: "Строка user-agent",
  browserUaSet: "Эта строка уйдёт в --user-agent, navigator.userAgent и подсказки Sec-CH-UA.",
  ...
  browserUaHint:
    "Меняет строку запроса, navigator.userAgent и Sec-CH-UA. Canvas, WebGL, шрифты, экран и число ядер остаются настоящими и общими у всех профилей этой машины: это разделение аккаунтов, а не антидетект. Одинаковый для всех отпечаток даёт движок Firefox.",
  ...
  browserZone: "Часовой пояс",
  browserZoneHint: (zone: string) => `Сейчас окно получит ${zone}. Ставится через канал DevTools: переменную TZ Chromium на Windows не читает`,
  browserZoneAuto: "Пояс: по стране узла",
  browserZoneSystem: "Пояс: системный — выдаёт, где вы",
  browserZoneCustom: "Пояс: свой",
  ...
  browserSearch: "Найти профиль — по имени, узлу или метке",
  browserTagsAll: "все",
  browserTags: "Метки",
  browserTagsHint: "Через запятую. По ним список отбирается сверху",
  browserTagsPlaceholder: "работа, магазин",
  browserOnce: "Одноразовый",
  browserOnceHint: "Входы и куки стираются, когда окно закрыли. Узел, user-agent и язык остаются",
  browserOnceMark: "одноразовый",
  browserEngine: "Движок",
  browserCompatibility: "Совместимость с проверками сайтов",
  browserCompatibilityHint: "Оставляет настоящий UA, часовой пояс и отпечаток без DevTools и RFP. Cloudflare и похожие проверки видят обычный браузер; отдельный сеанс, прокси и защита WebRTC сохраняются.",
  browserCompatibilityMark: "обычный браузер",
  browserCompatibleEngineHint: "Обычный Chromium или Firefox без подмены отпечатка; окно по-прежнему идёт через свой узел",
  browserFirefox: "Firefox — защита от отпечатка",
  browserChromiumHint: "Своя строка UA с подсказками Sec-CH-UA, язык и часовой пояс; canvas, шрифты и экран остаются настоящими и общими у профилей этой машины",
  browserFirefoxHint: "privacy.resistFingerprinting: UA, экран, шрифты, canvas и часовой пояс (UTC) — те же, что у всех с этой защитой. Строку UA Firefox пишет сам, язык берётся из формы",
  browserEditItem: "Изменить",
  browserClone: "Клонировать",
  browserCloneHint: "Новый профиль с тем же узлом и личностью, но без входов",
  browserTrashAct: "В корзину",
  browserTrashLive: "Окно открыто и останется без сети. Убрать?",
  browserTrash: "Корзина",
  browserTrashHint: "Удалённые профили. Их входы лежат на диске, пока профиль не стёрт навсегда",
  browserRestore: "Вернуть",
  browserPurge: (name: string) => `Стереть «${name}» навсегда вместе с входами и куками`,
  browserPurgeAsk: "Стереть? Входы не вернуть",
  browserNameInTrash: "Такое имя у профиля в корзине — верните его или сотрите навсегда.",
  browserTrashedAt: (date: string) => `удалён ${date}`,
  browserNoMatch: "Ничего не нашлось",
  ...
  copyLinkHint: "Ссылка на этот узел — в буфер обмена: перенести на телефон или отдать другому",
  showQr: "Показать QR",
  showQrHint: "Та же ссылка кодом: снять телефоном, не пересылая её через мессенджер",
  noLink: "Этот узел в ссылку без потерь не перекладывается — он остаётся JSON",
  copyFailed: "Не удалось положить в буфер обмена",
  save: "Сохранить",
  cancel: "Отмена",
  testOne: "Проверить",
  ...
  plainHint: "Трафик до сервера идёт открытым текстом: провайдер видит, куда идут соединения, а у прокси — ещё логин и пароль",
...
const EN: typeof RU = {
  ...
  browserMismatch: (real: string) =>
    `Sec-CH-UA and navigator.platform change along with the string, but fonts, rendering and WebGL stay those of "${real}": a site that cross-checks them sees the mismatch.`,
  browserUa: "user-agent — empty means the real one",
  browserUaField: "User-agent string",
  browserUaSet: "This string goes into --user-agent, navigator.userAgent and the Sec-CH-UA hints.",
  browserUaRealNow: (platform: string, major: number) =>
    `Nothing is substituted — the browser goes with its own. Here that is ${platform}, Chrome ${major}.`,
  browserUaHint:
    "Changes the request header, navigator.userAgent and Sec-CH-UA. Canvas, WebGL, fonts, screen and core count stay real and shared by every profile on this machine: this separates accounts, it is not an antidetect. The Firefox engine gives a fingerprint shared by everyone.",
  browserUaReal: "real",
  ...
  browserZone: "Time zone",
  browserZoneHint: (zone: string) => `The window will get ${zone}. Set through the DevTools channel: Chromium on Windows ignores the TZ variable`,
  browserZoneAuto: "Zone: by node country",
  browserZoneSystem: "Zone: system — reveals where you are",
  browserZoneCustom: "Zone: custom",
  ...
  browserSearch: "Find a profile — by name, node or tag",
  browserTagsAll: "all",
  browserTags: "Tags",
  browserTagsHint: "Comma-separated. The list is filtered by them at the top",
  browserTagsPlaceholder: "work, shop",
  browserOnce: "Disposable",
  browserOnceHint: "Logins and cookies are wiped when the window closes. The node, user agent and language stay",
  browserOnceMark: "disposable",
  browserEngine: "Engine",
  browserCompatibility: "Website-check compatibility",
  browserCompatibilityHint: "Keeps the real UA, time zone and fingerprint without DevTools or RFP. Cloudflare and similar checks see a regular browser; the separate session, proxy and WebRTC protection remain.",
  browserCompatibilityMark: "regular browser",
  browserCompatibleEngineHint: "Regular Chromium or Firefox without fingerprint overrides; the window still uses its own node",
  browserFirefox: "Firefox — fingerprint protection",
  browserChromiumHint: "Your own UA string with Sec-CH-UA hints, language and time zone; canvas, fonts and screen stay real and shared by profiles on this machine",
  browserFirefoxHint: "privacy.resistFingerprinting: UA, screen, fonts, canvas and time zone (UTC) match everyone else with this protection. Firefox writes the UA string itself; the language comes from the form",
  browserEditItem: "Edit",
  browserClone: "Clone",
  browserCloneHint: "A new profile with the same node and identity, but no logins",
  browserTrashAct: "Move to trash",
  browserTrashLive: "The window is open and will lose its network. Move?",
  browserTrash: "Trash",
  browserTrashHint: "Removed profiles. Their logins stay on disk until the profile is deleted for good",
  browserRestore: "Restore",
  browserPurge: (name: string) => `Delete "${name}" for good with its logins and cookies`,
  browserPurgeAsk: "Delete? Logins cannot be recovered",
  browserNameInTrash: "A profile in the trash has this name — restore it or delete it for good.",
  browserTrashedAt: (date: string) => `removed ${date}`,
  browserNoMatch: "Nothing found",
  ...
  nodeParam: "Parameter",
  copyLink: "Copy link",
  copyLinkHint: "Put this node's share-link on the clipboard: move it to a phone or pass it on",
  showQr: "Show QR",
  showQrHint: "The same link as a code: scan it with a phone instead of messaging it",
  noLink: "This node does not fit into a link without losing fields — it stays JSON",
  ...
  browserOn: "browser",
  plain: "unencrypted",
  plainHint: "Traffic to the server travels in the clear: your provider sees where connections go, and for a proxy also its login and password",
...
const FA: typeof RU = {
  ...
  browserMismatch: (real: string) =>
    `Sec-CH-UA و navigator.platform همراه رشته عوض می‌شوند، ولی فونت‌ها، رندر و WebGL از «${real}» می‌مانند: سایتی که آن‌ها را با رشته می‌سنجد، ناهمخوانی را می‌بیند.`,
  browserUa: "user-agent — خالی یعنی واقعی",
  browserUaField: "رشتهٔ user-agent",
  browserUaSet: "این رشته به ‎--user-agent، navigator.userAgent و راهنماهای Sec-CH-UA می‌رود.",
  browserUaRealNow: (platform: string, major: number) =>
    `چیزی جایگزین نمی‌شود — مرورگر با رشتهٔ خودش می‌رود. اینجا یعنی ${platform}، کروم ${major}.`,
  browserUaHint:
    "سربرگ درخواست، navigator.userAgent و Sec-CH-UA را عوض می‌کند. Canvas، WebGL، فونت‌ها، صفحه و شمار هسته‌ها واقعی و میان همهٔ پروفایل‌های این رایانه مشترک می‌مانند: این جدا کردن حساب‌هاست، نه ضدشناسایی. اثر انگشتی یکسان برای همه را موتور Firefox می‌دهد.",
  browserUaReal: "واقعی",
  browserLang: "زبان",
  ...
  browserZone: "منطقهٔ زمانی",
  browserZoneHint: (zone: string) => `پنجره اکنون ${zone} را می‌گیرد. از راه کانال DevTools تنظیم می‌شود: Chromium در ویندوز متغیر TZ را نمی‌خواند`,
  browserZoneAuto: "منطقه: بر پایهٔ کشور گره",
  browserZoneSystem: "منطقه: سیستمی — جای شما را لو می‌دهد",
  browserZoneCustom: "منطقه: دلخواه",
  ...
  browserSearch: "یافتن پروفایل — با نام، گره یا برچسب",
  browserTagsAll: "همه",
  browserTags: "برچسب‌ها",
  browserTagsHint: "با ویرگول جدا کنید. فهرست بالا با آن‌ها صافی می‌شود",
  browserTagsPlaceholder: "کار، فروشگاه",
  browserOnce: "یک‌بارمصرف",
  browserOnceHint: "ورودها و کوکی‌ها با بستن پنجره پاک می‌شوند. گره، user-agent و زبان می‌مانند",
  browserOnceMark: "یک‌بارمصرف",
  browserEngine: "موتور",
  browserCompatibility: "سازگاری با بررسی‌های وب‌سایت",
  browserCompatibilityHint: "UA، منطقهٔ زمانی و اثر انگشت واقعی را بدون DevTools یا RFP نگه می‌دارد. Cloudflare و بررسی‌های مشابه یک مرورگر عادی می‌بینند؛ نشست جدا، پراکسی و محافظت WebRTC باقی می‌مانند.",
  browserCompatibilityMark: "مرورگر عادی",
  browserCompatibleEngineHint: "Chromium یا Firefox عادی بدون تغییر اثر انگشت؛ پنجره همچنان از گرهٔ خودش استفاده می‌کند",
  browserFirefox: "Firefox — محافظت از اثر انگشت",
  browserChromiumHint: "رشتهٔ UA خودتان با راهنماهای Sec-CH-UA، زبان و منطقهٔ زمانی؛ canvas، فونت‌ها و صفحه واقعی و میان پروفایل‌های این دستگاه مشترک می‌مانند",
  browserFirefoxHint: "privacy.resistFingerprinting: UA، صفحه، فونت‌ها، canvas و منطقهٔ زمانی (UTC) مانند همهٔ کسانی است که این محافظت را دارند. رشتهٔ UA را خود Firefox می‌نویسد و زبان از فرم می‌آید",
  browserEditItem: "ویرایش",
  browserClone: "شبیه‌سازی",
  browserCloneHint: "پروفایل تازه با همان گره و هویت، ولی بی ورود",
  browserTrashAct: "به سطل زباله",
  browserTrashLive: "پنجره باز است و بی شبکه می‌ماند. برداشته شود؟",
  browserTrash: "سطل زباله",
  browserTrashHint: "پروفایل‌های برداشته. ورودهایشان تا پاک شدن همیشگی روی دیسک می‌ماند",
  browserRestore: "برگرداندن",
  browserPurge: (name: string) => `پاک کردن همیشگی «${name}» همراه با ورودها و کوکی‌ها`,
  browserPurgeAsk: "پاک شود؟ ورودها برنمی‌گردند",
  browserNameInTrash: "پروفایلی در سطل زباله همین نام را دارد — آن را برگردانید یا برای همیشه پاک کنید.",
  browserTrashedAt: (date: string) => `برداشته در ${date}`,
  browserNoMatch: "چیزی پیدا نشد",
  ...
  copyLinkHint: "پیوند این گره در حافظهٔ موقت: برای انتقال به گوشی یا دادن به دیگری",
  showQr: "نمایش QR",
  showQrHint: "همان پیوند به شکل کد: با گوشی بردارید، بی‌آنکه در پیام‌رسان بفرستید",
  noLink: "این گره بدون از دست رفتن میدان‌ها در پیوند جا نمی‌شود — به‌صورت JSON می‌ماند",
  copyFailed: "نوشتن در حافظهٔ موقت ممکن نشد",
  save: "ذخیره",
  cancel: "انصراف",
  testOne: "بررسی",
  ...
  browserOn: "مرورگر",
  plain: "بدون رمزگذاری",
  plainHint: "ترافیک تا سرور بدون رمزگذاری می‌رود: ارائه‌دهندهٔ اینترنت می‌بیند اتصال‌ها به کجا می‌روند و در پراکسی نام کاربری و گذرواژه را هم",
...
const ZH: typeof RU = {
  ...
  browserMismatch: (real: string) =>
    `Sec-CH-UA 和 navigator.platform 会随字符串一起替换，但字体、渲染和 WebGL 仍来自“${real}”：比对它们的网站会看出不一致。`,
  browserUa: "user-agent — 留空即真实值",
  browserUaField: "user-agent 字符串",
  browserUaSet: "该字符串将写入 --user-agent、navigator.userAgent 和 Sec-CH-UA 提示。",
  browserUaRealNow: (platform: string, major: number) =>
    `不做替换 — 浏览器用自己的。这里是 ${platform}，Chrome ${major}。`,
  browserUaHint:
    "改变请求头、navigator.userAgent 和 Sec-CH-UA。Canvas、WebGL、字体、屏幕和核心数保持真实，且本机所有配置共用：这是账号隔离，不是指纹伪装。人人相同的指纹由 Firefox 引擎提供。",
  browserUaReal: "真实",
  browserLang: "语言",
  ...
  browserZone: "时区",
  browserZoneHint: (zone: string) => `窗口将使用 ${zone}。通过 DevTools 通道设置：Windows 上的 Chromium 不读取 TZ 变量`,
  browserZoneAuto: "时区：按节点所在国家",
  browserZoneSystem: "时区：系统 — 会暴露您的位置",
  browserZoneCustom: "时区：自定义",
  ...
  browserSearch: "查找配置 — 按名称、节点或标签",
  browserTagsAll: "全部",
  browserTags: "标签",
  browserTagsHint: "用逗号分隔。可在上方按标签筛选列表",
  browserTagsPlaceholder: "工作, 商店",
  browserOnce: "一次性",
  browserOnceHint: "关闭窗口时清除登录信息和 Cookie。节点、user-agent 和语言保留",
  browserOnceMark: "一次性",
  browserEngine: "引擎",
  browserCompatibility: "网站验证兼容模式",
  browserCompatibilityHint: "保留真实的 UA、时区和指纹，不使用 DevTools 或 RFP。Cloudflare 等验证会看到普通浏览器；独立会话、代理和 WebRTC 防护仍然保留。",
  browserCompatibilityMark: "普通浏览器",
  browserCompatibleEngineHint: "不修改指纹的普通 Chromium 或 Firefox；窗口仍通过自己的节点连接",
  browserFirefox: "Firefox — 防指纹",
  browserChromiumHint: "自定义 UA 字符串及 Sec-CH-UA 提示、语言和时区；canvas、字体和屏幕保持真实，并在本机各配置间共用",
  browserFirefoxHint: "privacy.resistFingerprinting：UA、屏幕、字体、canvas 和时区（UTC）与所有启用该防护的用户一致。UA 字符串由 Firefox 自行填写，语言取自表单",
  browserEditItem: "编辑",
  browserClone: "克隆",
  browserCloneHint: "新建配置，节点和身份相同，但没有登录信息",
  browserTrashAct: "移入回收站",
  browserTrashLive: "窗口开着，将失去网络。仍要移除吗？",
  browserTrash: "回收站",
  browserTrashHint: "已移除的配置。永久删除之前，它们的登录信息仍留在磁盘上",
  browserRestore: "恢复",
  browserPurge: (name: string) => `永久删除“${name}”及其登录信息和 Cookie`,
  browserPurgeAsk: "删除？登录信息无法恢复",
  browserNameInTrash: "回收站中的配置使用了这个名称 — 请恢复它或永久删除。",
  browserTrashedAt: (date: string) => `移除于 ${date}`,
  browserNoMatch: "未找到",
  ...
  nodeParam: "参数",
  copyLink: "复制链接",
  copyLinkHint: "把该节点的分享链接复制到剪贴板：转到手机或交给别人",
  showQr: "显示二维码",
  showQrHint: "同一条链接的二维码：用手机扫，不必再发消息转发",
  noLink: "该节点无法无损转换为链接，只能保留 JSON",
  copyFailed: "无法写入剪贴板",
  save: "保存",
  cancel: "取消",
  testOne: "检测",
  ...
  browserOn: "浏览器",
  plain: "未加密",
  plainHint: "到服务器的流量是明文：运营商能看到连接去往何处，代理的用户名和密码也能看到",
...
const TR: typeof RU = {
  ...
  browserMismatch: (real: string) =>
    `Sec-CH-UA ve navigator.platform metinle birlikte değişir, ama yazı tipleri, çizim ve WebGL «${real}» olarak kalır: bunları metinle karşılaştıran bir site uyuşmazlığı görür.`,
  browserUa: "user-agent — boş ise gerçek olan",
  browserUaField: "user-agent metni",
  browserUaSet: "Bu metin --user-agent, navigator.userAgent ve Sec-CH-UA ipuçlarına gider.",
  browserUaRealNow: (platform: string, major: number) =>
    `Hiçbir şey değiştirilmiyor — tarayıcı kendininkiyle gider. Burada bu ${platform}, Chrome ${major}.`,
  browserUaHint:
    "İstek başlığını, navigator.userAgent değerini ve Sec-CH-UA'yı değiştirir. Canvas, WebGL, yazı tipleri, ekran ve çekirdek sayısı gerçek kalır ve bu makinedeki tüm profillerde ortaktır: bu hesap ayrımıdır, izsizlik değil. Herkes için aynı parmak izini Firefox motoru verir.",
  ...
  browserZone: "Saat dilimi",
  browserZoneHint: (zone: string) => `Pencere şimdi ${zone} alacak. DevTools kanalıyla ayarlanır: Windows’taki Chromium TZ değişkenini okumaz`,
  browserZoneAuto: "Dilim: düğümün ülkesine göre",
  browserZoneSystem: "Dilim: sistem — nerede olduğunuzu ele verir",
  browserZoneCustom: "Dilim: özel",
  ...
  browserSearch: "Profil bul — ada, düğüme veya etikete göre",
  browserTagsAll: "tümü",
  browserTags: "Etiketler",
  browserTagsHint: "Virgülle ayırın. Liste üstte bunlara göre süzülür",
  browserTagsPlaceholder: "iş, mağaza",
  browserOnce: "Tek kullanımlık",
  browserOnceHint: "Pencere kapanınca oturumlar ve çerezler silinir. Düğüm, user-agent ve dil kalır",
  browserOnceMark: "tek kullanımlık",
  browserEngine: "Motor",
  browserCompatibility: "Site denetimleriyle uyumluluk",
  browserCompatibilityHint: "DevTools veya RFP kullanmadan gerçek UA, saat dilimi ve parmak izini korur. Cloudflare ve benzeri denetimler normal bir tarayıcı görür; ayrı oturum, proxy ve WebRTC koruması kalır.",
  browserCompatibilityMark: "normal tarayıcı",
  browserCompatibleEngineHint: "Parmak izi değiştirilmemiş normal Chromium veya Firefox; pencere yine kendi düğümünü kullanır",
  browserFirefox: "Firefox — parmak izi koruması",
  browserChromiumHint: "Sec-CH-UA ipuçlarıyla kendi UA dizeniz, diliniz ve saat diliminiz; canvas, yazı tipleri ve ekran gerçek kalır ve bu makinedeki profillerde ortaktır",
  browserFirefoxHint: "privacy.resistFingerprinting: UA, ekran, yazı tipleri, canvas ve saat dilimi (UTC) bu korumayı kullanan herkesle aynıdır. UA dizesini Firefox kendisi yazar, dil formdan gelir",
  browserEditItem: "Düzenle",
  browserClone: "Kopyala",
  browserCloneHint: "Aynı düğüm ve kimlikle, ama oturumsuz yeni profil",
  browserTrashAct: "Çöp kutusuna taşı",
  browserTrashLive: "Pencere açık ve ağsız kalacak. Taşınsın mı?",
  browserTrash: "Çöp kutusu",
  browserTrashHint: "Kaldırılan profiller. Oturumları, profil kalıcı olarak silinene dek diskte kalır",
  browserRestore: "Geri yükle",
  browserPurge: (name: string) => `«${name}» profilini oturumları ve çerezleriyle kalıcı olarak sil`,
  browserPurgeAsk: "Silinsin mi? Oturumlar geri gelmez",
  browserNameInTrash: "Çöp kutusundaki bir profil bu adı taşıyor — onu geri yükleyin ya da kalıcı olarak silin.",
  browserTrashedAt: (date: string) => `${date} tarihinde kaldırıldı`,
  browserNoMatch: "Hiçbir şey bulunamadı",
  ...
  nodeText: "Metin",
  nodeHost: "Adres",
  nodePort: "Bağlantı noktası",
  nodeParam: "Parametre",
  copyLink: "Bağlantıyı kopyala",
  copyLinkHint: "Bu düğümün paylaşım bağlantısını panoya al: telefona taşı ya da başkasına ver",
  showQr: "QR göster",
  showQrHint: "Aynı bağlantı kod olarak: mesajla göndermeden telefonla okutun",
  noLink: "Bu düğüm alan kaybetmeden bağlantıya dönüşmüyor — JSON olarak kalıyor",
  copyFailed: "Panoya yazılamadı",
  save: "Kaydet",
  cancel: "Vazgeç",
  testOne: "Dene",
  ...
  browserOn: "tarayıcı",
  plain: "şifresiz",
  plainHint: "Sunucuya giden trafik açık metin: sağlayıcınız bağlantıların nereye gittiğini, proxy için kullanıcı adı ve parolayı da görür",
...
const ID: typeof RU = {
  ...
  browserMismatch: (real: string) =>
    `Sec-CH-UA dan navigator.platform ikut berganti bersama teksnya, tetapi font, render, dan WebGL tetap milik «${real}»: situs yang mencocokkannya dengan teks akan melihat ketidakcocokan.`,
  browserUa: "user-agent — kosong berarti yang asli",
  browserUaField: "Teks user-agent",
  browserUaSet: "Teks ini masuk ke --user-agent, navigator.userAgent, dan petunjuk Sec-CH-UA.",
  browserUaRealNow: (platform: string, major: number) =>
    `Tidak ada yang diganti — peramban memakai miliknya sendiri. Di sini itu ${platform}, Chrome ${major}.`,
  browserUaHint:
    "Mengubah tajuk permintaan, navigator.userAgent, dan Sec-CH-UA. Canvas, WebGL, font, layar, dan jumlah inti tetap asli dan sama untuk semua profil di mesin ini: ini pemisahan akun, bukan antideteksi. Sidik jari yang sama untuk semua diberikan mesin Firefox.",
  browserUaReal: "asli",
  browserLang: "Bahasa",
  ...
  browserZone: "Zona waktu",
  browserZoneHint: (zone: string) => `Jendela akan memakai ${zone}. Diatur lewat kanal DevTools: Chromium di Windows tidak membaca variabel TZ`,
  browserZoneAuto: "Zona: menurut negara node",
  browserZoneSystem: "Zona: sistem — membocorkan lokasi Anda",
  browserZoneCustom: "Zona: sendiri",
  ...
  browserSearch: "Cari profil — menurut nama, node, atau label",
  browserTagsAll: "semua",
  browserTags: "Label",
  browserTagsHint: "Pisahkan dengan koma. Daftar di atas disaring menurut label",
  browserTagsPlaceholder: "kerja, toko",
  browserOnce: "Sekali pakai",
  browserOnceHint: "Sesi masuk dan kuki dihapus saat jendela ditutup. Node, user-agent, dan bahasa tetap",
  browserOnceMark: "sekali pakai",
  browserEngine: "Mesin",
  browserCompatibility: "Kompatibilitas pemeriksaan situs",
  browserCompatibilityHint: "Mempertahankan UA, zona waktu, dan sidik jari asli tanpa DevTools atau RFP. Cloudflare dan pemeriksaan serupa melihat peramban biasa; sesi terpisah, proxy, dan perlindungan WebRTC tetap aktif.",
  browserCompatibilityMark: "peramban biasa",
  browserCompatibleEngineHint: "Chromium atau Firefox biasa tanpa perubahan sidik jari; jendela tetap memakai node sendiri",
  browserFirefox: "Firefox — perlindungan sidik jari",
  browserChromiumHint: "String UA sendiri dengan petunjuk Sec-CH-UA, bahasa, dan zona waktu; canvas, font, dan layar tetap asli dan sama untuk semua profil di mesin ini",
  browserFirefoxHint: "privacy.resistFingerprinting: UA, layar, font, canvas, dan zona waktu (UTC) sama dengan semua pengguna perlindungan ini. String UA ditulis Firefox sendiri, bahasa diambil dari formulir",
  browserEditItem: "Ubah",
  browserClone: "Klon",
  browserCloneHint: "Profil baru dengan node dan identitas yang sama, tanpa sesi masuk",
  browserTrashAct: "Pindahkan ke tempat sampah",
  browserTrashLive: "Jendela sedang terbuka dan akan kehilangan jaringan. Pindahkan?",
  browserTrash: "Tempat sampah",
  browserTrashHint: "Profil yang dihapus. Sesi masuknya tetap di disk sampai profil dihapus permanen",
  browserRestore: "Pulihkan",
  browserPurge: (name: string) => `Hapus «${name}» permanen beserta sesi masuk dan kukinya`,
  browserPurgeAsk: "Hapus? Sesi masuk tidak bisa kembali",
  browserNameInTrash: "Nama ini dipakai profil di tempat sampah — pulihkan atau hapus permanen.",
  browserTrashedAt: (date: string) => `dihapus ${date}`,
  browserNoMatch: "Tidak ada yang ditemukan",
  ...
  copyLinkHint: "Taruh tautan berbagi node ini ke papan klip: pindahkan ke ponsel atau berikan ke orang lain",
  showQr: "Tampilkan QR",
  showQrHint: "Tautan yang sama sebagai kode: pindai dengan ponsel, tanpa mengirim pesan",
  noLink: "Node ini tidak muat ke dalam tautan tanpa kehilangan ruas — tetap JSON",
  copyFailed: "Gagal menulis ke papan klip",
  save: "Simpan",
  cancel: "Batal",
  testOne: "Uji",
  ...
  active: "aktif",
  browserOn: "peramban",
  plain: "tanpa enkripsi",
  plainHint: "Lalu lintas ke server berjalan tanpa enkripsi: penyedia internet melihat ke mana koneksi pergi, dan pada proksi juga nama pengguna dan kata sandinya",
