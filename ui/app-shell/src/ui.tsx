...
const FIELD =
  "selectable h-8 w-full min-w-0 flex-1 rounded-lg border border-edge bg-surface-2 px-3 text-[13px] outline-none placeholder:text-muted focus:border-accent";
