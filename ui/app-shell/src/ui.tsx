...
/** Три шрифта на выбор — те же, что и во всём окне: заводить ради аватарки
 *  четвёртый значило бы тащить в сборку начертание ради одной буквы. Различаются
 *  они сразу: узкий гротеск заголовков, обычный текстовый и моноширинный. */
const FONTS = ["var(--font-display)", "var(--font-sans)", "var(--font-mono)"];
